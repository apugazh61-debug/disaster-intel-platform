...
export default function App() {
      ...
      try {
        ...
        if (msg.type === 'prediction_update') {
          ...
          const sosAlert = {
            ...
            message: `SOS Distress Beacon from ${sos.citizen_name} (Phone: ${sos.phone}) near coordinates [${sos.latitude}, ${sos.longitude}]. Team dispatched from ${sos.assigned_shelter} (ETA: ~${sos.eta_minutes} mins).`,
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-gradient-to-br from-slate-100 via-sky-50/40 to-slate-200 text-slate-800 font-sans">
      {/* Streamlined White Glassmorphism Header */}
      <Header
